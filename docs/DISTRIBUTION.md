...
The packaging work should be tested with real edit projects, not just app launch smoke tests. Video editors fail at the edges: filesystem permissions, codec discovery, GPU drivers, font rendering, render-cache paths, and export destinations.
